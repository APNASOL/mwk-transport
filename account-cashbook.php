        ...
        <div class="pagetitle">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row mt-3" action="Controllers/CashBookController.php" method="post"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Floating Labels Form -->
                        <form class="row g-3" action="Controllers/ProfitController.php" method="post"
                            onsubmit="handleSubmit(event, this)">
                                    ...
                                    <select class="form-control chosen" placeholder="" name="month" id="selected_month">
                                        ...
                                        while ($m_result = mysqli_fetch_array($selectmonth)) {
                                            if ($m_result["code"] == $month) {
                                                ?>
                                                <option value="<?php echo $m_result["name"]; ?>" selected>
                                                    <?php echo $m_result["name"]; ?></option>
                                                <?php
                                            } else {
                                                ?>
                                                <option value="<?php echo $m_result["name"]; ?>"><?php echo $m_result["name"]; ?>
                                                </option>
                                                <?php
                                            }
                                        } ?>
        ...
        <div class="modal fade" id="giveToVehicle" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Floating Labels Form -->
                        <form class="row g-3" action="Controllers/CashBookController.php" method="post"
                            onsubmit="handleSubmit(event, this)">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="hidden" value="<?php echo $_SESSION['current_vehicle_id']; ?>"
                                        name="m_c_id" id="m_v_id" />
                                    <label>.</label>
                                    <select class="form-control chosen" placeholder="" name="year" id="selected_year_v">
                                        ...
                                        while ($p_s_result = mysqli_fetch_array($selectuser)) {
                                            if ($p_s_result["year"] == $year) { ?>
                                                <option value="<?php echo $p_s_result["year"]; ?>" selected>
                                                    <?php echo $p_s_result["year"]; ?></option>
                                                <?php
                                            } else {
                                                ?>
                                                <option value="<?php echo $p_s_result["year"]; ?>">
                                                    <?php echo $p_s_result["year"]; ?></option>
                                                <?php
                                            }
                                ...
                                <div class="col-md-2">
                                    <label>.</label>
                                    <select class="form-control chosen" placeholder="" name="year"
                                        id="selected_month_v">
                                        <?php
                                        $selectmonthquery = "SELECT * FROM months ORDER BY id";
                                        $selectmonth = mysqli_query($conn, $selectmonthquery);
                                        while ($m_result = mysqli_fetch_array($selectmonth)) {
                                            if ($m_result["code"] == $month) { ?>
                                                <option value="<?php echo $m_result["code"] ?>" selected>
                                                    <?php echo $m_result["name"]; ?></option>
                                                <?php
                                            } else {
                                                ?>
                                                <option value="<?php echo $m_result["code"]; ?>"><?php echo $m_result["name"]; ?>
                                                </option>
                                                <?php
                                            }
                                        }
                                ...
                                <div class="col-md-1 mt-2">
                                    <button class="mt-4 btn btn-dark btn-flat m_search" name="day_search_button"> <i
