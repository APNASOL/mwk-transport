              ...
              <form class="row g-3" action="Controllers/StockController.php" method="post">
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    ...
                    <label for="balnce">Quantity</label>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    ...
                    <label for="balnce">Unit Price</label>
                  </div>
                </div>

                  
                <div class="text-center">
                  <button type="submit" name="create_stock" class="btn btn-dark">Add</button>
