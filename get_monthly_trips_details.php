...
if (isset($_POST['month'])) {
    ...
    $vehicle_details = mysqli_query($conn, "SELECT date, ANY_VALUE(id) AS id, ANY_VALUE(vehicle_id) AS vehicle_id, ANY_VALUE(date) AS date, ANY_VALUE(status) AS status FROM vehicle_details WHERE vehicle_id =  $c_id and YEAR(date) = '$year' AND MONTH(date) = '$month' GROUP BY date");
