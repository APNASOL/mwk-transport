...
$vehicle_detail_id = $_GET['id'];
$Records = mysqli_query($conn, "SELECT * FROM vehicle_details WHERE id = '$vehicle_detail_id'");
$record = mysqli_fetch_array($Records);

$consume_id = $record['transaction_id'];

$vehicle_detail_id = $record['id'];
            ...
            <div class="card">
                <div class="card-body p-5">
                    <form class="row g-3" action="Controllers/VehicleController.php" method="post" onsubmit="handleSubmit(event, this)">
                        <input type="hidden" class="form-control" name="transaction_id"
                            value="<?php echo $vehicle_detail_id; ?>">
                        <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        ...
                        <?php if ($notes == 'Returned cash back to customer' || $notes == 'Cash given to vehicle' || $notes == 'Payed to pump') {?>
                        <input type="number" class="form-control" id="cash_out" name="cash_out" required
                ...
                <form class="row g-3" action="Controllers/VehicleController.php" method="post" onsubmit="handleSubmit(event, this)">
                        <input type="hidden" name="transaction_id" value="<?php echo $vehicle_detail_id; ?>">
